  ...
  render() {
    ...
    return (<div>
      ...
      <div className="shopping-cart">
        ...
        {cartList && cartList.length > 0 && cartList.map((product, index )=> {
          return (
            <div className="product" key={product.cartId}>
              <div className="product-image">
                <img src={product.thumbnailUrl} />
              </div>
              <div className="product-details">
                <div className="product-title">Dingo Dog Bones</div>
                <p className="product-description">The best dog bones of all time. Holy crap. Your dog
              ...
              <div className="product-removal">
                <button className="remove-product" onClick={()=> this.removeActionHandler(product)}>
                  Remove
                </button>
              </div>
